...
| **v1.0 — Launch** | Feedback submission (thumbs up/down + c
omment); End-to-end performance optimisation (target: ≤ 30s P95); Security audit (RLS policies, signed URL expiry, API key management); WCAG 2.1 AA review; Rate limiting on OpenAI calls; Onboarding tooltips for first-time users | Weeks 12–14 |
